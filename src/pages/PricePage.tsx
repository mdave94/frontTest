...
function PricePage() {
  return (
    <>
      ...
      <div
        className=" center"
        style={{ fontSize: "32px", paddingTop: "100px" }}
      >
        ÁRAINK
      </div>
        ...
        <div className="pricepage-container">
          ...
          <div className="pricepage-section">
            ...
            <div className="price-box">
              Arany ékszer ékkövek nélkül: ~ 200.000 Ft <br></br> Arany ékszer 1
              db ékkővel díszítve ~ 250.000 - 350.000 Ft<br></br> Arany ékszer
              több ékkővel díszítve: ~350.000 -450.000 Ft
            </div>
          </div>
        </div>
      </div>
